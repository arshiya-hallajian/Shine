            ...
            <div class="container">
                <div class="footer_kenar">
                    <div class="footer_card">
                        <h4>_ درباره ما</h4>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحانگرافیک است. چاپگرها و متون بلکه روزنامه و مجلهدرستون و سطرآنچنان که لازماست و برای..</p>
                    </div>
                </div>
                ...
                <div class="footer_vasat">
                    <div class="footer_card">
                        ...
                        <ul>
                            ...
                            <li><span>تلفن:44341839</span> </li>
                            <li><span> ایمیل:myaghoobi@gmail.com</span></li>
                            <li><span>آدرس:فارس-آباده-خیابان دلاوران-پلاک5</span> </li>
                        </ul>
                    </div>
                </div>
